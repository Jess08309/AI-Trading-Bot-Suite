...
if "%ENABLE_COINBASE_FUTURES_DATA%"=="" set "ENABLE_COINBASE_FUTURES_DATA=true"
if "%ENABLE_KRAKEN_FUTURES_FALLBACK%"=="" set "ENABLE_KRAKEN_FUTURES_FALLBACK=true"
if "%DIRECTION_BIAS%"=="" set "DIRECTION_BIAS=short_lean"
if "%DIRECTION_BIAS_STRENGTH%"=="" set "DIRECTION_BIAS_STRENGTH=0.06"
