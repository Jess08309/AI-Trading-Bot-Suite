"""Run the v2 (real intraday underlying data) PutSeller backtest and print a summary.

Usage: python3 run_putseller_v2.py [start] [end]
"""
import sys
...
result, _ = run_backtest(start, end)
