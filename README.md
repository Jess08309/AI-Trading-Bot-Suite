...
*Last audited: 2026-04-21 — see [reports/AUDIT_LATEST.md](reports/AUDIT_LATEST.md) for the full report.*

| Item | Details |
|------|---------|
| **Broker** | Alpaca (paper trading account) |
| **Starting Capital (options)** | $100,000 (simulated) |
| **Starting Capital (crypto)** | $5,000 (simulated) |
| **Current Options Equity** | ~$91,300 |
| **Current Crypto Equity** | ~$4,750 |
| **Grand Total** | ~$96,050 (−8.5% vs $105K start) |
| **PutSeller Allocation / P&L** | 35% / **+$11,190** |
| **CallBuyer Allocation / P&L** | 15% / **+$57,601** (97% from one GOOGL event — real edge is ≈+$900) |
| **CryptoBot P&L** | **−$169** lifetime, +$20 last 24h (post-tune) |
| **AlpacaBot** | 0% (retired after −89%) |
...
### Current Health (2026-04-21)

- **Infrastructure:** 🟢 10+ days continuous uptime, 0 service errors in last 24h
- **PutSeller:** 🟢 profitable (+$11k), one known bug (EMERGENCY_CALL trigger fires too late)
- **CallBuyer:** 🟡 profitable on paper but heavily GOOGL-dependent; ML still in warmup
- **CryptoBot:** 🟡 negative lifetime but improving post-tune; SIDE regime is the main drag
- **AlpacaBot:** ⚫ dormant by design
