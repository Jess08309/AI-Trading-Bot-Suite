...
echo Position size: max=%MAX_POSITION_PCT_OVERRIDE% per trade ^| Per-symbol caps: spot=%MAX_POSITIONS_PER_SYMBOL_SPOT_OVERRIDE% futures=%MAX_POSITIONS_PER_SYMBOL_FUTURES_OVERRIDE% ^| Max corr=%MAX_CORRELATION_OVERRIDE%
